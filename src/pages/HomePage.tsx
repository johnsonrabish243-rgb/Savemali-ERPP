      ...
      <section className="bg-[#f9fafb] dark:bg-[#0f0f12] py-16 sm:py-24 lg:py-[96px]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              { q: fr ? "Qu'est-ce que SaveMali ?" : "What is SaveMali?", a: fr ? "SaveMali est une plateforme ERP tout-en-un conçue pour les entreprises en RDC et Afrique centrale. Elle intègre la gestion de pharmacie, commerce, éducation, entreprise et ressources humaines dans une seule interface." : "SaveMali is an all-in-one ERP platform designed for businesses in the DRC and Central Africa. It integrates pharmacy, commerce, education, business management, and human resources in a single interface." },
