    ...
    <div className="min-h-svh flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#c8399c] to-[#7c3aed] flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#c8399c]/50 focus:border-[#c8399c] transition-all"
              required
            />
          </div>
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-[#c8399c] to-[#7c3aed] text-white font-semibold shadow-lg hover:shadow-xl hover:opacity-90 transition-all disabled:opacity-50"
          >
            {loading
