  ...
  fr: {
    ...
    dashboard: {
      ...
      settings: {
        ...
        myAccountDesc: "Gérez votre profil et vos préférences régionales",
        display: "Affichage",
        ...
        workspaceDesc: "Gérez les paramètres de votre organisation",
        ...
        privacy: "Confidentialité",
        privacyDesc: "Gérez vos données et votre vie privée",
        exportData: "Exporter mes données",
        exportDataDesc: "Téléchargez une archive de toutes vos données",
        deleteAccount: "Supprimer mon compte",
        deleteAccountDesc: "Suppression définitive de votre compte et de vos données",
        connectedDevices: "Appareils connectés",
        connectedDevicesDesc: "Appareils ayant accès à votre compte",
        system: "Système",
        systemDesc: "État du service et intégrations",
        activityLog: "Journal d'activité",
        activityLogDesc: "Trace de toutes les actions sur votre espace",
        serviceHealth: "État du service",
        serviceHealthDesc: "Disponibilité et performance de la plateforme",
        integrations: "Intégrations",
        integrationsDesc: "Connectez vos outils externes",
        settings: "Paramètres",
      },
    hr: {
      title: "Ressources Humaines",
  ...
  en: {
    ...
    dashboard: {
      ...
      settings: {
        ...
        myAccountDesc: "Manage your profile and regional preferences",
        display: "Display",
        ...
        email: "Email",
        workspace: "Workspace",
        workspaceDesc: "Manage your organization settings",
        ...
        exportDataDesc: "Download an archive of all your data",
        deleteAccount: "Delete my account",
        deleteAccountDesc: "Permanent deletion of your account and data",
        connectedDevices: "Connected devices",
        connectedDevicesDesc: "Devices with access to your account",
        system: "System",
        systemDesc: "Service status and integrations",
        activityLog: "Activity log",
        activityLogDesc: "Trace of all actions in your workspace",
        serviceHealth: "Service health",
        serviceHealthDesc: "Platform availability and performance",
        integrations: "Integrations",
        integrationsDesc: "Connect your external tools",
        settings: "Settings",
      },
    hr: {
      title: "Human Resources",
